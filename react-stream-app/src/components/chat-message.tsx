...
import { useAIState, useChannelStateContext, useMessageContext, useMessageTextStreaming } from "stream-chat-react";
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col space-y-1">
                    ...
                    <div
                    className={cn(
                        "px-4 py-3 rounded-2xl text-sm leading-relaxed transition-all duration-200 relative group",
                        isUser
                        ...
                        components={{
                            ...
                            code: ({children, ...props}) => {
                                ...
                                return isInLine ? (
                                    ...
                                    <pre className="p-3 rounded-md overflow-x-auto my-2 text-s font-mono bg-black/5 dark:bg-white/5">
                            ...
                            blockquote: ({children}) => (<blockquote className="border-1-3 pl-3 my-2 italic border-current/30">{children}</blockquote>),
