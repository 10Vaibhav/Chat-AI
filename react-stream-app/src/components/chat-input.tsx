...
export const ChatInput: React.FC<ChatInputProps> = ({
    ...
    return (
        ...
        >
            {showPromptToolBar && (<WritingPromptsToolbar onPromptSelect={handlePromptSelect}/>)}
                    ...
                    <div className="relative">
                        ...
                        {/* Send/Stop Button inside textarea */}
                        {
                            isGenerating ? (
                                ...
                                className="absolute right-2 bottom-2 h-8 w-8 rounded-md shrink-0 p-0"
                                variant={"destructive"}
                                ...
                                className={cn(
                                    "absolute right-2 bottom-2 h-8 w-8 rounded-md shrink-0 p-0",
